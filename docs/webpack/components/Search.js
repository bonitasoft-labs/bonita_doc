...
const url_tab = window.location.href.split('/')
const url_domaine =  url_tab[0]+"//"+url_tab[2]+"/"+url_tab[3]

const docSite = url_tab[4]
const version = url_tab[5]


console.log(docSite)
console.log(version) 

const ELASTICSEARCH_URL = 'http://'+ELASTICSEARCH_SOCKET+'/'+docSite+"_"+version;
